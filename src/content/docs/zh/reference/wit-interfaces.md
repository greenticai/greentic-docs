---
title: WIT 接口
description: Greentic 的 WebAssembly Interface Types 规范
---

## 概述

Greentic 使用 **WIT (WebAssembly Interface Types)** 定义组件接口。所有 WASM 组件都必须实现相应的 WIT 接口。
...
- [Components Guide](/zh/concepts/components/)
- [Creating MCP Tools](/zh/mcp/creating-tools/)
