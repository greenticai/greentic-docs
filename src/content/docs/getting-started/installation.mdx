...
### Redis (Session Storage & Agentic Workers)

For production session persistence, and required for [Agentic Workers](/concepts/agentic-workers/) — the `dw.agent` node uses Redis for multi-turn memory and is disabled without it:
...
# Preview the wizard without writing any files
gtc wizard --dry-run
```
...
- [Quick Start](/getting-started/quick-start/) - Create your first worker
