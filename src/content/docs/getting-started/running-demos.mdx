...
<Aside type="tip">
Replace `<demo>` with one of the demo IDs in the catalog below. The bundle directory created in step 1 is named after the demo (e.g. `quickstart-demo-bundle`).
</Aside>
...
The minimal Greentic experience. A welcome card, an about card, and a basic echo interaction — useful as a smoke test that your toolchain, tunnel, and WebChat front-end are working end-to-end.
