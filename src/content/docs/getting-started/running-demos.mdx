...
A research worker with two modes: a fast single-shot research analyst and a fuller [agentic](/concepts/agentic-workers/) workflow that routes the question through a research planner and analyst.
