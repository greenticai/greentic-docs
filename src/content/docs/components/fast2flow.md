...
- [Flows Guide](/greentic-docs/concepts/flows/) — Learn about `.ygtc` flow definitions
- [Packs Guide](/greentic-docs/concepts/packs/) — Understand `.gtpack` distribution
- [Control Chains Reference](/greentic-docs/reference/control-chains/) — Hook registration and policies
