...
4. **Install with Add to Slack**

   Setup exposes an **Add to Slack** action. It registers the Slack app, opens the Slack OAuth install flow, and persists the app id and OAuth answers for the tenant.
