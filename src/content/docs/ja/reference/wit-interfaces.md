---
title: WIT インターフェース
description: Greentic のための WebAssembly Interface Types 仕様
---

## 概要

Greentic は、コンポーネントインターフェースを定義するために **WIT (WebAssembly Interface Types)** を使用します。すべての WASM コンポーネントは、適切な WIT インターフェースを実装する必要があります。
...
- [Components ガイド](/ja/concepts/components/)
- [MCP ツールの作成](/ja/mcp/creating-tools/)
