...
Pack Slack mendeklarasikan aksi setup generik:
...
| Output setup wajib | `slack_add_url` |

Host setup dapat merender ini sebagai tombol, menampilkan URL, dan menyediakan snippet HTML setelah setup mengembalikan `setup_status.ok: true`. Pisahkan aksi pasca-setup ini dari **Setup Slack App**, yaitu aksi khusus provider yang membuat atau memperbarui konfigurasi app.
