...
Setelah setup berhasil, pack Webex mengekspos aksi setup generik melalui `greentic.setup.actions.v1`:
...
| Output setup wajib | `bot_email` |

Host setup dapat merender ini sebagai tombol, menampilkan URL, dan menyediakan snippet HTML. Link ini membuka Webex dengan pesan baru yang ditujukan ke bot.
