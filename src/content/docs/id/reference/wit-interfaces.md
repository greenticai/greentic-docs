---
title: Interface WIT
description: Spesifikasi WebAssembly Interface Types untuk Greentic
---

## Ringkasan

Greentic menggunakan **WIT (WebAssembly Interface Types)** untuk mendefinisikan interface komponen. Semua komponen WASM harus mengimplementasikan interface WIT yang sesuai.
...
## Menggunakan WIT dalam Komponen
...
- [Components Guide](/id/concepts/components/)
- [Creating MCP Tools](/id/mcp/creating-tools/)
