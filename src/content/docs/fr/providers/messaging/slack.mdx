...
6. **Get App Credentials**
   ...
   - Configuration Token if you want Greentic to update the app manifest automatically
...
<Aside type="note">
The setup layer also accepts the older `bot_token` alias and stores it as `slack_bot_token`, but new answers files should use the wizard-generated key.
</Aside>
