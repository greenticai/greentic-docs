...
Le catalogue actuel inclut des packs de messagerie pour Slack, Microsoft Teams, Telegram, WhatsApp, WebChat, WebChat GUI, Webex, SMTP Email, Microsoft Graph Email, HTTP et WebSocket.
