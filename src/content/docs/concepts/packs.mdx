...
3. **Add your flows**
   ...
   Write orchestration flows in `.ygtc` (YAML) format under `flows/`. See the [Flows guide](/greentic-docs/concepts/flows/) for the full schema.
...
- [Components](/greentic-docs/concepts/components/) — learn how to build WASM components for packs
- [Building Packs](/greentic-docs/cli/building-packs/) — CLI commands for pack management
- [Pack Format Reference](/greentic-docs/reference/pack-format/) — complete `.gtpack` specification
- [Flows](/greentic-docs/concepts/flows/) — write orchestration flows for your packs
