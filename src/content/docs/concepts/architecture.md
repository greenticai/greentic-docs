...
- [Flows](/greentic-docs/concepts/flows/) - Learn about flow definitions
- [Packs](/greentic-docs/concepts/packs/) - Understand pack structure
- [Components](/greentic-docs/concepts/components/) - Build custom WASM components
