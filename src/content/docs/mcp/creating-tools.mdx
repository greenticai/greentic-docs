...
`gtdx new --kind` accepts `design`, `bundle`, `deploy`, `provider`, `wasm-component`, `mcp`, `llm`, and `addon`. See [gtdx CLI](/extensions/gtdx-cli/) for the full scaffolding surface.
