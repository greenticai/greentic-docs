...
يتضمن الكتالوج الحالي packs مراسلة لـ Slack وMicrosoft Teams وTelegram وWhatsApp وWebChat وWebChat GUI وWebex وSMTP Email وMicrosoft Graph Email وHTTP وWebSocket.
...
<CardGrid>
  ...
  <LinkCard
    title="HTTP"
    href="/ar/providers/messaging/http/"
    description="ربط طلبات HTTP الواردة وبناء استدعاءات HTTP الصادرة"
  />
  <LinkCard
    title="WebSocket"
    href="/ar/providers/messaging/websocket/"
