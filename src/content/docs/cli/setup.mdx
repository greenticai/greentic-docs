...
- [gtc start](/greentic-docs/cli/start/) - Run the runtime server
- [Telegram Setup](/greentic-docs/providers/messaging/telegram/) - Detailed Telegram guide
- [Slack Setup](/greentic-docs/providers/messaging/slack/) - Detailed Slack guide
