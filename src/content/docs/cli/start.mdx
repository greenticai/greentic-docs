...
- [Building Packs](/greentic-docs/cli/building-packs/) - Create and manage packs
- [Configuration Reference](/greentic-docs/reference/configuration/) - Full config options
- [Troubleshooting Guide](/greentic-docs/reference/troubleshooting/) - Common issues
