---
title: WIT-Schnittstellen
description: Spezifikation der WebAssembly Interface Types für Greentic
---

## Überblick

Greentic verwendet **WIT (WebAssembly Interface Types)**, um Komponentenschnittstellen zu definieren. Alle WASM-Komponenten müssen die passende WIT-Schnittstelle implementieren.
...
## Messaging-Provider-Schnittstelle
...
## Verwendung von WIT in Komponenten
...
- [Komponenten-Leitfaden](/de/concepts/components/)
