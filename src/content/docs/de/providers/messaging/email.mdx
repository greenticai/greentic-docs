...
`messaging-email` ist ein SMTP-Provider fuer ausgehende E-Mails. Er fragt keine IMAP- oder POP3-Postfaecher ab. Eingehende E-Mails werden normalerweise ueber einen Event-Provider oder Provider-Webhook verarbeitet, zum Beispiel SendGrid Inbound Parse, Mailgun Routes, AWS SES oder Microsoft Graph subscriptions, wenn das installierte Pack sie unterstuetzt.
