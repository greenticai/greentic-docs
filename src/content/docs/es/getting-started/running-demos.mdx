...
<Aside type="tip">
Sustituye `<demo>` por uno de los IDs de demo del catálogo siguiente. El directorio de bundle creado en el paso 1 lleva el nombre de la demo (por ejemplo, `quickstart-demo-bundle`).
</Aside>
